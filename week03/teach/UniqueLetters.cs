...
public static class UniqueLetters {
    ...
    private static bool AreUniqueLetters(string text) {
        ...
        // creates a new set of chars and compares it to the length of the text looking for duplicates
        var newset = new HashSet<char>(text);
        if(text.Length == newset.Count)
            return true;
